...
rng default
nvars = 5;
[x,fval,exitflag,output,population,scores] = pso(@PerformanceIndexFunction_MECA,nvars,[],[],[],[],lb,ub,[],options);
toc
...
mkdir data/231206
save('data/231206/PSO_MECA_data','halfOn','occusalCutOn','axialCutOn','maxillaOn','mandibleOn','n_angle',...
