...
tic
rng default
[x,fval,exitflag,output,population,scores] = ga(@PerformanceIndexFunction_wTool,9,[],[],[],[],lb,ub,[],options);
...
mkdir data/240215
save('data/240215/ga_tool_data','halfOn','occusalCutOn','axialCutOn','maxillaOn','mandibleOn','n_angle',...
